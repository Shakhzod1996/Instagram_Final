let arr = [
  {
    ...
    desc: `«Najot Ta'lim» markazida Foundation dasturlash bosqichida ta'lim olayotgan o'quvchilar uchun bir necha kun avval mutaxassislik kursiga o'tish imtihoni bo'lib o'tgan edi.<br> Mantiq va algoritmlash bo'yicha bo'lib o'tgan imtihonda 162 nafar o'quvchilar keyingi bosqichga o'tish uchun harakat qilib ko'rdilar. <br> Ushbu o'tish imtihonida eng yuqori ball to'plagan 9 nafar o'quvchiga, «Najot Ta'lim» markazi tomonidan istalgan bitta mutaxassislik kursida o'qish uchun chegirmalar taqdim qilinadi.`,
    likeNumber: 20,
    comentNumber: 13,
    save: false,
  },

  {
    ...
    desc: `O'zbekistondagi xususiy ta'lim salohiyatini yanada rivojlantirish maqsadida EduOn va Oliygoh.uz hamkorligida "Edu-Branding" tanlovi e'lon qilingan edi. <br> Tanlov natijalariga ko'ra, 3257 ta ovoz bilan «Najot Ta'lim» markazi «Eng yaxshi IT maktab» nominatsiyasining g'olibi deb topildi. <br> Ushbu tanlovda «Najot Ta'lim» markaziga ishonch bildirib, o'z ovozini bergan insonlarga va tanlov tashkilotchilariga jamoamiz nomidan samimiy minnatdorchilik bildiramiz. <br> 😊 🚀 Siz tomoningizdan bildirilgan ushbu ishonchni oqlash uchun doimo harakat qilamiz.`,
    likeNumber: 47,
    comentNumber: 22,
    save: false,
  },
...

  {
    ...
    desc: `Men Najot Ta’lim jamoasiga birgaliklari uchun, ta’limni rivojlantirishda. <br> Qo’shayotgan hissalari uchun va albatta bugun sayohat uchun tashakkur izhor qilaman! Boringizga shukr! )`,
    likeNumber: 130,
    comentNumber: 43,
    save: false,
  },
...

  {
    ...
    desc: `Xabaringiz bor, Najot Ta'lim markazida 5-mart sanasidan boshlab, haftaning har shanba kuni dizayn sohasining bo'lajak vakillarini saralab olish uchun dizayn foundation bosqichi imtihonlari bo'lib o'tdi. <br> Jumladan, bugun ham imtihonlar tashkil etildi. 🚀 Kirish imtihonlarida o'quvchilarning grafik dizayn, mantiq va ingliz tili bo'yicha tuzilgan savollarga bergan javoblari bir necha bosqichli tekshiruvlardan o'tkazildi. <br> Dizayn foundation bosqichi uchun ushbu davrgacha umumiy hisobda 577 nafar nomzodlar ro'yxatdan o'tgan bo'lib, ularning 228 nafari kirish imtihonlarida qatnashishdi. Ulardan 151 nafari esa o'qish uchun qabul qilindi. <br> 📌 Kirish imtihonlaridan muvaffaqiyatli o'tgan barcha o'quvchilar 2-aprel kuniga qadar markazimiz bilan shartnoma tuzishlari talab etiladi.`,
    likeNumber: 65,
    comentNumber: 3,
    save: false,
  },

  {
    ...
    desc: `🎯 Hozirgi kunda «Opera branding agency»da grafik dizayner bo'lib faoliyat olib borayotgan Sevara ismli bitiruvchimiz bilan tanishing.<br> Sevara o'zida sohaga bo'lgan qiziqishni sezganidan so'ng kompyuter uchun pul yig'ishni boshlagani, 800 nafar nomzodlar ichidan «Najot Ta'lim»da o'qish uchun grant yutganligi va karantin davridagi o'qish davri haqida hikoya qilib berdi. <br>Agar siz ham zamonaviy kasblardan birini o'rganishni istasangiz, izohlarda ➕ belgisini qoldiring!`,
    likeNumber: 123,
    comentNumber: 43,
    save: false,
  },

  {
    ...
    desc: `"Osmondagi bolalar" loyihasining yorqin mehmoni, "Yuksalish" liderlar akademiyasi asoschisi – Muhammadali Eshonqulov bilan master-klass bo'lib o'tdi. Suhbatda yoshlar uchun muhim hisoblangan mavzular: ilm olish, muvaffaqiyatga erishish yo'llari va ruhiyat haqida so'z bordi. Bundan tashqari, o'quvchilarimiz o'zlarini qiziqtirgan savollar bo'yicha mehmonimiz tomonidan javob oldilar. Tez orada ushbu suhbat premyerasini «Najot Ta'lim» YouTube sahifasi orqali tomosha qilishingiz mumkin!`,
    likeNumber: 460,
    comentNumber: 102,
    save: false,
  },

  {
    ...
    desc: `Yodingizda bo'lsa, avvalroq grafik dizaynerlar o'qishi kerak bo'lgan kitoblar to'plamini tavsiya qilgan edik. <br>Ushbu postning izohlar qismida kuzatuvchilarimiz tomonidan dasturchilar uchun ham kitob tavsiya qilishimiz so'ralgan edi. Obunachilarimizning fikrlarini inobatga olgan holda, bu gal dasturchilar o'qishi kerak bo'lgan kitoblar to'plamini tavsiya qilishga qaror qildik. <br>Ushbu kasb egalari uchun o'z sohalariga doir ushbu kitoblar foydali bo'ladi, degan umiddamiz. 😊P. S. Sizlar uchun yana qanday kontentlar qo'yib borsak, manfaatli bo'ladi deb o'ylaysiz? <br> Qimmatli fikringizni izohlarda qoldiring. 😉`,
    likeNumber: 305,
    comentNumber: 78,
    save: false,
  },
...
function modalShow(id) {
  ...
  modalInArr.forEach((item) => {
    if (item.media[0].indexOf(".mp4") !== -1) {
      ...
      divMod.innerHTML = `
      <div class='left-img'>
      <div class='img-video-flex2' ondblclick='love2Clicked(${item.id})'>
      <i class='bx bxs-heart  dblove'></i>
      <video autoplay class='second-video' src=${item.media[0]}></video>
...
// ?Clicked The Love Image
function love2Clicked(idImg) {
  let dbClick = document.querySelector(".dblove");
  let likeH4 = document.querySelector(".like-h4");
  let heart = document.querySelector(".heart-for");
  arr.forEach((ar) => {
    let like = ar.likeNumber;
    if (idImg == ar.id) {
      if (!ar.save) {
        likeH4.innerHTML = like + 1 + " likes";
        dbClick.classList.add("dblove-cliked");
        ar.save = true;
        heart.classList.toggle("heart-for-clicked");
      } else {
        likeH4.innerHTML = like + " likes";
        ar.save = false;
        dbClick.classList.remove("dblove-cliked");
        heart.classList.toggle("heart-for-clicked");
      }
    }
  });
